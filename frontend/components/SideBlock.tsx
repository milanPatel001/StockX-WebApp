...
function SideBlock(props: any) {
  return (
    <div className="flex flex-col w-full md:w-1/2 mx-auto lg:h-full lg:w-full gap-4 p-4 divide-y divide-gray border border-gray-400 rounded-lg">
